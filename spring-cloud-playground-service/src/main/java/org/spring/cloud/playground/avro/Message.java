 ...
 */
package org.spring.cloud.playground.avro;
...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4993414888343618920L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"org.spring.cloud.playground.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"message\",\"type\":\"string\"}]}");
   ...
   */
  public Message(java.lang.CharSequence name, java.lang.CharSequence message) {
    this.name = name;
   ...
   */
  public static org.spring.cloud.playground.avro.Message.Builder newBuilder() {
    return new org.spring.cloud.playground.avro.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static org.spring.cloud.playground.avro.Message.Builder newBuilder(org.spring.cloud.playground.avro.Message.Builder other) {
    if (other == null) {
      return new org.spring.cloud.playground.avro.Message.Builder();
    } else {
      return new org.spring.cloud.playground.avro.Message.Builder(other);
    }
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static org.spring.cloud.playground.avro.Message.Builder newBuilder(org.spring.cloud.playground.avro.Message other) {
    if (other == null) {
      return new org.spring.cloud.playground.avro.Message.Builder();
    } else {
      return new org.spring.cloud.playground.avro.Message.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.spring.cloud.playground.avro.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.spring.cloud.playground.avro.Message other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.spring.cloud.playground.avro.Message.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.spring.cloud.playground.avro.Message.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.spring.cloud.playground.avro.Message.Builder setMessage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.spring.cloud.playground.avro.Message.Builder clearMessage() {
      message = null;
